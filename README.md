...
This is the repository of my team robot software for the CENTERSTAGE (2023-2024) competition season.
The code used can be a bit older so pay attention to make the appropiate changes when using it.
It's not the good code reference for the autonomous peroid.
